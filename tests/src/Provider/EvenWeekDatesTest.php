...
use Robier\WorkingDay\Provider\EvenWeekDates;
use Robier\WorkingDay\Tests\Mocks;

class EvenWeekDatesTest extends TestCase
{
    use Mocks;
    ...
    public function dataProvider()
    {
        ...
        [
            ...
            [[Day\Type::WEDNESDAY, Day\Type::THURSDAY, Day\Type::FRIDAY], '1991-11-15', false],
    ...
    {
        $week = new EvenWeekDates($this->mockShiftsCollection(...$dates), $this->mockMetaCollection());
