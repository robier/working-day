...
use Robier\WorkingDay\Provider\OddWeekDates;
use Robier\WorkingDay\Tests\Mocks;

class OddWeekDatesTest extends TestCase
{
    use Mocks;
    ...
    public function dataProvider()
    {
        ...
        return
            [
                ...
                [[Day\Type::WEDNESDAY, Day\Type::THURSDAY, Day\Type::FRIDAY], '1991-11-14', false],
                [[Day\Type::WEDNESDAY, Day\Type::THURSDAY, Day\Type::FRIDAY], '1991-11-15', true],
                [[Day\Type::THURSDAY, Day\Type::FRIDAY, Day\Type::SATURDAY], '1991-11-16', false],
    ...
    {
        $week = new OddWeekDates($this->mockShiftsCollection(...$dates), $this->mockMetaCollection());
